...
const htmlTaskContent = ({ id, title, description, type, url }) => `
  ...
  <div class="col-md-6 col-lg-4 mb-4" id=${id} key=${id}>
    <div class="card shadow-sm task__card">
      <div
        class="card-header d-flex justify-content-end gap-2 m-0 task__card__header"
     >
      <button type="button" class="btn btn-outline-success" name=${id} onclick="editTask.apply(this, arguments)">
        <i class="fas fa-pencil-alt" name=${id} onclick="editTask.apply(this, arguments)"></i>
      </button>
      <button type="button" class="btn btn-outline-danger" name=${id} onclick="deleteTask.apply(this, arguments)">
        <i class="fas fa-trash" name=${id}  onclick="deleteTask.apply(this, arguments)"></i>
      </button>
    </div>
